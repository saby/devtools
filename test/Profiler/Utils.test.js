define(['Profiler/_utils/Utils', 'Elements/elements', 'Extension/Plugins/Elements/const'], function(
   ...
   it('applyOperations', function() {
      ...
      const secondOperation = [OperationType.CREATE, 2, 'Test3', ControlType.TEMPLATE, 1];
   ...
   it('convertProfilingData', function() {
      ...
      const frontendProfilingData = convertProfilingData(backendProfilingData);
   ...
   describe('getChangesDescription', function() {
      ...
      it('should return undefined', function() {
         ...
         assert.isUndefined(getChangesDescription(profilingData, 'test', 123));
      });
   });
   ...
   describe('getBackgroundColorBasedOnReason', function() {
      ...
      it('should return color for unchanged', function() {
         assert.equal(getBackgroundColorBasedOnReason('unchanged'), '#e2e2e2');
      });
