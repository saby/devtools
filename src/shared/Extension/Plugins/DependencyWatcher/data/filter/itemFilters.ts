...
import { IRPCModuleFilter, IRPCModuleInfo } from 'Extension/Plugins/DependencyWatcher/IRPCModule';
...
const itemFilters: Partial<Record<keyof IRPCModuleFilter, FilterFunctionGetter<any, IRPCModuleInfo>>> = {
    name: getForName,
    files: getForFiles,
    css:  ignoreWrap(css),
