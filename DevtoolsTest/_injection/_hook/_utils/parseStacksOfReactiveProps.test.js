         ...
         const result = parseStacksOfReactiveProps([
            {
               ...
               stack:
                  INTERNAL_STACK +
                  'eval at req.exec (https://fix-cdn.sbis.ru/cdn/RequireJS/2.3.5-p5/require-min.js:1:5064), <anonymous>\n' +
                  'eval at new req.exec (https://fix-cdn.sbis.ru/cdn/RequireJS/2.3.5-p5/require-min.js:1:5064)\n' +
                  'at new req.exec (https://fix-cdn.sbis.ru/cdn/RequireJS/2.3.5-p5/require-min.js:1:5064)\n' +
                  'at https://fix-cdn.sbis.ru/cdn/RequireJS/2.3.5-p5/require-min.js:1:5064'
            },
            {
               name: 'excludedKeys',
               stack:
                  INTERNAL_STACK +
                  'at overrides.constructor.f (eval at req.exec (https://fix-cdn.sbis.ru/cdn/RequireJS/2.3.5-p5/require-min.js:1:5064), <anonymous>:3:2948)\n' +
               ...
               stack: [
                  {
                     name: 'req.exec',
                     url:
                        'https://fix-cdn.sbis.ru/cdn/RequireJS/2.3.5-p5/require-min.js',
                     lineNumber: 0
                  },
                  {
                     name: 'req.exec',
